...
//        });
        ...
        presc.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                Answers.getInstance().logContentView(new ContentViewEvent()
                        .putContentName("Dialog")
                        .putContentType("About Libs Dialog"));
                ...
                AlertDialog.Builder dialogAL = new AlertDialog.Builder(getActivity(), R.style.MyAlertDialogStyle);
                ...
                try {
                    // Load from changelog.html in the assets folder
                    StringBuilder buf = new StringBuilder();
                    InputStream json = getActivity().getAssets().open("about_libs.html");
                    BufferedReader in = new BufferedReader(new InputStreamReader(json, "UTF-8"));
                    String str;
                    while ((str = in.readLine()) != null)
                        buf.append(str);
